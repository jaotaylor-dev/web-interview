...
Persistering sker via SQLite (`better-sqlite3`). Databasfilen `todos.sqlite` skapas automatiskt vid första start — ingen extern installation krävs. Schemat innehåller två tabeller: `todo_lists` och `todo_items`. Exempeldata seedas om databasen är tom.
